...
<html>
	<head>
		...
		<header>
			...
			<form method="post" action="neIgrajNaEngleze.php" class="izborJezika" name="izborJezika"
	...
	<body>
		...
		<div class="glavni">
			...
			<br>
			<img src="neIgrajNaEnglezeSlika.jpg" alt="Ne igraj na Engleze slika">
		</div>
		<div class="pomocni">
			<div class="donjiLijevi">
				...
				<?php
					$query = "SELECT * FROM jezik WHERE naziv='uloge4'";
					$result = mysqli_query($con, $query);
					$row = mysqli_fetch_array($result);
					if(!empty($_POST))	
						echo $row[$_POST['jezik']];
			...
			<div class="donjiDesni">
				...
				<?php
					$query = "SELECT * FROM jezik WHERE naziv='radnja4'";
					$result = mysqli_query($con, $query);
					$row = mysqli_fetch_array($result);
					if(!empty($_POST))	
						echo $row[$_POST['jezik']];
