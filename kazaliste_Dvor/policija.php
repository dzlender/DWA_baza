...
<html>
	<head>
		...
		<header>
			...
			<form method="post" action="policija.php" class="izborJezika" name="izborJezika"
	...
	<body>
		...
		<div class="glavni">
			...
			<br>
			<img src="policijaSlika.jpg" alt="Policija slika">
		</div>
		<div class="pomocni">
			<div class="donjiLijevi">
				...
				<?php
					$query = "SELECT * FROM jezik WHERE naziv='uloge3'";
					$result = mysqli_query($con, $query);
					$row = mysqli_fetch_array($result);
					if(!empty($_POST))	
						echo $row[$_POST['jezik']];
			...
			<div class="donjiDesni">
				...
				<?php
					$query = "SELECT * FROM jezik WHERE naziv='radnja3'";
					$result = mysqli_query($con, $query);
					$row = mysqli_fetch_array($result);
					if(!empty($_POST))	
						echo $row[$_POST['jezik']];
