...
<html>
	<head>
		...
		<header>
			...
			<form method="post" action="politickoVjencanje.php" class="izborJezika" name="izborJezika"
	...
	<body>
		...
		<div class="glavni">
			...
			<br>
			<img src="politickoVjencanjeSlika.jpg" alt="Političko vjenčanje slika">
		</div>
		<div class="pomocni">
			<div class="donjiLijevi">
				...
				<?php
					$query = "SELECT * FROM jezik WHERE naziv='uloge5'";
					$result = mysqli_query($con, $query);
					$row = mysqli_fetch_array($result);
					if(!empty($_POST))	
						echo $row[$_POST['jezik']];
			...
			<div class="donjiDesni">
				...
				<?php
					$query = "SELECT * FROM jezik WHERE naziv='radnja5'";
					$result = mysqli_query($con, $query);
					$row = mysqli_fetch_array($result);
					if(!empty($_POST))	
						echo $row[$_POST['jezik']];
