...
<html>
	<head>
		...
		<header>
			...
			<form method="post" action="spektakluk.php" class="izborJezika" name="izborJezika"
	...
	<body>
		...
		<div class="glavni">
			...
			<br>
			<img src="spektaklukSlika.jpg" alt="Spektakluk slika">
		</div>
		<div class="pomocni">
			<div class="donjiLijevi">
				...
				<?php
					$query = "SELECT * FROM jezik WHERE naziv='uloge2'";
					$result = mysqli_query($con, $query);
					$row = mysqli_fetch_array($result);
					if(!empty($_POST))	
						echo $row[$_POST['jezik']];
			...
			<div class="donjiDesni">
				...
				<?php
					$query = "SELECT * FROM jezik WHERE naziv='radnja2'";
					$result = mysqli_query($con, $query);
					$row = mysqli_fetch_array($result);
					if(!empty($_POST))	
						echo $row[$_POST['jezik']];
